...
"""Schlankes, helles Erscheinungsbild (QSS) fuer die PolderFit-GUI.

Akzentfarben aus dem App-Icon: PolderFit-Gold (#E8A317) und Blattgruen (#3FA34D).
Bewusst zurueckhaltend – klar und leicht, aber nicht ueberladen.
"""

from __future__ import annotations

PolderFit_GOLD = "#E8A317"
PolderFit_GRUEN = "#3FA34D"
...
QProgressBar::chunk {{ background-color: {PolderFit_GOLD}; border-radius: 6px; }}
...
QSplitter::handle:hover {{ background-color: {PolderFit_GOLD}; }}
