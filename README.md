...
| `benchmark_ftf/` | Vergleich mit dem LabVIEW-FTF: `einfacher_vergleich_2026-08-25/VERGLEICH_EINFACH.md` (PolderFit minus FTF je Frequenz, ohne Statistik, eigener Ordner) und `BERICHT.md` (ausführlich, ältere Ergebnisse unter `ergebnisse/`) |
