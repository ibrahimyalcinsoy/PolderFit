...
| Fit gut, Fenster sichtbar falsch | Störfeature/Rauschen | Grenzgeraden (`Strg+L`), Rechteck-Nachfit, `_PROMINENZ_MIN` ↑ |
...
| Fenster sucht zu tief | stationäre Artefakte am Feldrand | Stationärabzug/Trasse; sonst Grenzgeraden |
